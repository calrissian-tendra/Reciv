This particular fork will eventually be rebuilt into a purpose-built front end for a post-apocalyptic rule-set based on Deciv Redux by SpacedOutChicken. This will be a long term project, as I have literally no experience with programming.
